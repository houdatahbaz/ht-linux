...
fn draw_help(frame: &mut Frame) {
    ...
    let help_text = vec![
        ...
        Line::from(""),
        Line::from("Quick Shortcuts:").style(Style::default().bold()),
        Line::from("  *           Overview"),
        Line::from("  c           CPU"),
        Line::from("  m           Memory"),
        Line::from("  d           Disks"),
        ...
        Line::from("  Enter       Open selected item / View details"),
        Line::from(""),
        ...
        Line::from("  x/Delete    Kill selected process (in Processes)"),
